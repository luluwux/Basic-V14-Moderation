...
module.exports = () => {
client.user.setPresence({activities:[{name: beş_config.clientPresence ? beş_config.clientPresence : `Lulu Was Here`,type: ActivityType.Streaming,url:"https://github.com/luluwux"}], status: "dnd" });
